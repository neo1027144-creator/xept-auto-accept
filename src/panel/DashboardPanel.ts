  ...
  <div class="dashboard">
    ...
    <section class="section collapsible" id="advanced-section">
      ...
      <div class="section-body" id="advanced-body">
        <div class="field"><label>Accept review delay</label><div class="slider-row"><input type="range" id="delay-accept" min="0" max="10000" step="500"><span id="delay-accept-value">2.0s</span></div></div>
        <div class="field"><label>Run command delay</label><div class="slider-row"><input type="range" id="delay-run" min="0" max="10000" step="500"><span id="delay-run-value">0.0s</span></div></div>
        <div class="field"><label>Retry / Continue delay</label><div class="slider-row"><input type="range" id="delay-retry" min="0" max="15000" step="500"><span id="delay-retry-value">5.0s</span></div></div>
        <div class="list-editor">
